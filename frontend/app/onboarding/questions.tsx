...
export default function OnboardingQuestions() {
  ...
  // User selections
  const [selectedNativeLanguage, setSelectedNativeLanguage] = useState<number | null>(null);
  const [selectedLearningLanguage, setSelectedLearningLanguage] = useState<number | null>(null);
