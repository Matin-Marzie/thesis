...
function RootLayoutNav() {
  ...
  useEffect(() => {
    ...
    const inVideosScreen = segments[0] === 'videos';
    ...
    if (!hasCompletedOnboarding) {
      ...
      if (!inTabsGroup && !inSettingsScreen && !inLettersScreen && !inVideosScreen && !inModal && !inGames && !inReelScreen && !inCreatorScreen && !inLoginOrRegister) {
        router.replace('/(tabs)');
      }
    }
