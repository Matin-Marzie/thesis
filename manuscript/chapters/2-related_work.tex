...
\label{sec:pedagogical_foundations}
    ...
    \label{subsec:srs_models}
        ...
        \begin{wrapfigure}{r}{0.48\textwidth}
            ...
            \includegraphics[width=\linewidth]{figures/ebbinghaus_curve.png}
        ...
        \begin{wrapfigure}{r}{0.48\textwidth}
            \centering
            \vspace{-0.5\baselineskip}
            \includegraphics[width=\linewidth]{figures/leitner_system.pdf}
...
\label{sec:synthesis}
    ...
    \begin{table}[htbp]
        ...
        \begin{tabular}{p{3.6cm}p{4.6cm}p{4.6cm}}
            ...
            Stage 1: Comprehensibility Filtering, 98\% lexical coverage (Sec.~\ref{sec:recommendation}) \\
            \hline
            ...
            Reel length and game session length constraints \\
            \hline
            Forgetting Curve \& Spaced Repetition (\ref{subsec:srs_models}) &
            Schedule review before predicted recall failure &
            Stage 2: SRS Scoring, \texttt{SRS\_Urgency} term (Sec.~\ref{sec:recommendation}) \\
            \hline
            ...
            Wordle-style and Word-of-Wonders vocabulary games (Sec.~\ref{sec:recommendation}) \\
            \hline
            ...
            Stage 1--3 cascade ranking (Sec.~\ref{sec:recommendation}) \\
            \hline
