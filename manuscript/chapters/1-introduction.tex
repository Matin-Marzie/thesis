...
\section{Background}
    ...
    Simultaneously, gamification has emerged as a cornerstone of digital instruction. The viability of gamified mobile systems is exemplified by Duolingo, which reported 140.6 million monthly active users (MAUs), 58.7 million daily active users (DAUs) \cite{duolingo2026q2}.
